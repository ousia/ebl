...
No es interesante el desarrollo de automatismo. La forma de la palabra viene de [αὐτοματισμός](http://www.perseus.tufts.edu/hopper/morph?l=αὐτοματισμός&la=greek) que es «azar» o «lo espontáneo». Es un nombre abstracto formado de un adjetivo [αὐτόματος](http://www.perseus.tufts.edu/hopper/morph?l=αὐτόματος&la=greek), que en nuestro idioma ha dado el adjetivo «automático». Aplicado a personas, significa por propia voluntad, aplicado a seres naturales es «por sí mismos» y aplicado a cosas significa «espontáneo». Aunque en realidad, el significado de ese conjunto de palabras lo determina τὰ αὐτόματα (adjetivo plural con función de nombre), del que proviene nuestro «autómata». Se trata de aquel mecanismo que funciona por sí mismo. «Automático» pasa a ser «lo relativo al autómata» y «automatismo» es «el modo en que opera el autómata».
